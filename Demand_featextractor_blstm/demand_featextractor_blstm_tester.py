...
class DemandCNNBLSTM_Tester():
    def __init__(self, cfg):
        ...
        self.model = CNNBLSTM(513).to(self.device)
        self.model.eval()
...
if __name__ == '__main__':
    from configs.demand_cnn_blstm_config_1 import test_cfg
    obj = DemandCNNBLSTM_Tester(test_cfg)
    obj.test()