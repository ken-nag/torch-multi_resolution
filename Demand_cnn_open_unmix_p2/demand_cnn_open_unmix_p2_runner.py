...
import time
sys.path.append('../')
from models.demand_cnn_oepnunmix_p2 import CNNOpenUnmix_p2
...
class FeatExtractorBlstm_p2_Runner():
...
if __name__ == '__main__':
    from configs.demand_cnn_openunmix_p2_config_1 import train_cfg
    obj = FeatExtractorBlstm_p2_Runner(train_cfg)
    obj.train()