...
class DemandBLSTM2Runner():
    def __init__(self, cfg):
        ...
        self.model = BLSTM2(f_size=513).to(self.device)
        self.criterion = PSA()
...
if __name__ == '__main__':
    from configs.demand_blstm2_config_1 import train_cfg
    obj = DemandBLSTM2Runner(train_cfg)
    obj.train()