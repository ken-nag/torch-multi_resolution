...
class DSDOpenUnmixRunner():
    ...
    def _run(self, mode=None, data_loader=None):
        running_loss = 0
        for i, (noisy, _, _, _, clean) in enumerate(data_loader):
...
if __name__ == '__main__':
    from configs.dsd_openunmix_config_1 import train_cfg
    obj = DSDOpenUnmixRunner(train_cfg)
    obj.train()