...
import time
sys.path.append('../')
from models.demand_cnn_oepnunmix_pp import CNNOpenUnmix_pp
...
class DemandCNNOpenUnmix_pp_Tester():
    def __init__(self, cfg):
        ...
        self.model =  CNNOpenUnmix_pp(cfg['dnn_cfg']).to(self.device)
        self.model.eval()
...
if __name__ == '__main__':
    from configs.demand_cnn_openunmix_pp_config_1 import test_cfg
    obj = DemandCNNOpenUnmix_pp_Tester(test_cfg)
    obj.test()