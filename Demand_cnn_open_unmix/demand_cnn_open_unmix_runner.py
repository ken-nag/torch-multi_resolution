...
import time
sys.path.append('../')
from models.demand_cnn_oepnunmix import CNNOpenUnmix
...
class DemandCNNOpenUnmixRunner():
    def __init__(self, cfg):
        ...
        self.model = CNNOpenUnmix(cfg['dnn_cfg']).to(self.device)
...
if __name__ == '__main__':
    from configs.demand_cnn_openunmix_config_1 import train_cfg
    obj = DemandCNNOpenUnmixRunner(train_cfg)
    obj.train()