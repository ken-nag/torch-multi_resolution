...
class DemandUNetRunner():
    def __init__(self, cfg):
        ...
        self.model = DemandUNet_p1().to(self.device)
        self.criterion = PSA()
    ...
    def _preprocess(self, noisy, clean):
        ...
        return noisy_mag_spec, ex1_noisy_mag_spec, clean_spec, noisy_spec, noisy_amp_spec, clean_amp_spec
    ...
    def _run(self, mode=None, data_loader=None):
        ...
        for i, (noisy, clean) in enumerate(data_loader):
            ...
            noisy_mag_spec, ex1_noisy_mag_spec, clean_spec, noisy_spec, noisy_amp_spec, clean_amp_spec = self._preprocess(noisy, clean)            
...
if __name__ == '__main__':
    from configs.demand_unet_p1_config_1 import train_cfg
