...
import time
sys.path.append('../')
from models.featextractor_blstm_pp_v2 import FeatExtractorBlstm_pp_v2
...
class FeatExtractorBlstm_pp_v2_Runner():
    def __init__(self, cfg):
        ...
        self.model = FeatExtractorBlstm_pp_v2(cfg['dnn_cfg']).to(self.device)
...
if __name__ == '__main__':
    from configs.demand_featextractor_blstm_pp_v2_config_1 import train_cfg
