...
import time
sys.path.append('../')
from models.demand_u_net_p2 import DemandUNet_p2
...
class DemandUNet_p2_Runner():
    def __init__(self, cfg):
        ...
        self.model = DemandUNet_p2().to(self.device)
        self.criterion = PSA()
    ...
    def _preprocess(self, noisy, clean):
        with torch.no_grad():
            ...
            return noisy_mag_spec, ex2_noisy_mag_spec, clean_amp_spec, noisy_amp_spec, noisy_spec, clean_spec
    ...
    def _run(self, mode=None, data_loader=None):
        ...
        for i, (noisy, clean) in enumerate(data_loader):
            ...
            noisy_mag_spec, ex2_noisy_mag_spec, clean_amp_spec,  noisy_amp_spec, noisy_spec, clean_spec = self._preprocess(noisy, clean)
...
if __name__ == '__main__':
    from configs.demand_unet_p2_config_1 import train_cfg
    obj = DemandUNet_p2_Runner(train_cfg)
    obj.train()
