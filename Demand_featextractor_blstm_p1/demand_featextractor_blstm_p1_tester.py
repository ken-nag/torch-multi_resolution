...
class DemandFeatExtractorBLSTM_p1_Tester():
    ...
    def _preprocess(self, noisy):
        with torch.no_grad():
            ...
            return noisy_mag_spec, ex1_noisy_mag_spec, noisy_spec
...
if __name__ == '__main__':
    from configs.demand_featextractor_blstm_p1_config_1 import test_cfg
    obj = DemandFeatExtractorBLSTM_p1_Tester(test_cfg)
    obj.test()
