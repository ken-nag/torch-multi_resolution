...
import time
sys.path.append('../')
from models.demand_cnn_oepnunmix_pp_v2 import CNNOpenUnmix_pp_v2
...
class FeatExtractorBlstm_pp_v2_Runner():
    def __init__(self, cfg):
        ...
        self.model = CNNOpenUnmix_pp_v2(cfg['dnn_cfg']).to(self.device)
...
if __name__ == '__main__':
    from configs.demand_cnn_openunmix_pp_v2_config_3 import train_cfg
    obj = FeatExtractorBlstm_pp_v2_Runner(train_cfg)
    obj.train()#!/usr/bin/env python3
